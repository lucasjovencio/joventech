                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-sm-6 col-md-5">
                                        <div class="about-img">
                                            <img src="{{ asset('imgs/lucas.jpg') }}" class="img-fluid rounded b-shadow-a" alt="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-7">
                                        <div class="about-info">
                                            ...
                                            <p><span class="title-s">Email: </span> <span>contato@joventech.com.br</span></p>
                                            <p><span class="title-s">Linkedin: </span> <span><a href="https://www.linkedin.com/in/lucas-jovencio-684404114/" target="_blank">linkedin/lucasjovencio</a></span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="skill-mf">
                            ...
                            <div class="col-md-6">
                                <div class="about-me pt-4 pt-md-0">
									...
									<p class="lead">
										Desenvolvedor backend em PHP com laravel, que adota as melhores praticas do mercado de
										desenvolvimento como Scrum, DDD, DRY, RESTful e DevOps.
									</p>
									<p class="lead">
										Atuei no mercado de desenvolvimento de sistemas para startup, Participando nos requisitos e viabilidades
										para termos MVP, arquitetura do projeto, desenvolvimento de app e desenvolvimento de web.
									</p>
                                </div>
                            </div>
                        </div>
				...
				<div class="col-md-4">
					<div class="service-box">
						...
						<div class="service-content">
							...
							<p class="s-description text-center">
								Desenvolvimento com framework Laravel, que é um framework php utilizado no mercado para desenvolvimento focado na produtividade e agilidade.
							</p>
						</div>
					</div>
				</div>
							...
							<div class="card-footer">
								<div class="post-author">
									<a href="#">
										...
										<span class="author">{{ $blog->autor->name }}</span>
									</a>
								</div>
								<div class="post-date">
									<span class="ion-ios-clock-outline"></span> {{ $blog->data_publicacao ?? '#' }}
								</div>
							</div>
						</div>
					</div>
						...
						<div id="contact" class="box-shadow-full">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="more-info">
										<p class="lead">
											<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d207331.1899586551!2d-40.25395154414254!3d-20.26618772873413!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1spt-BR!2sbr!4v1596026877293!5m2!1spt-BR!2sbr" width="100%" height="310" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
										</p>
										<ul class="list-ico">
											<li>
									...
									<div class="socials">
										<ul>
											<li>
												<a target="_blank" href="https://www.linkedin.com/in/lucas-jovencio-684404114/"><span class="ico-circle"><i
